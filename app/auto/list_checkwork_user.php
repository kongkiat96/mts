...
<?php
$i = 0;
$get_total = $getdata->my_sql_select($connect, NULL, "building_list", "work_flag IN ('user_approve') AND (user_key = '" . $_SESSION['ukey'] . "' OR manager_approve = '" . $_SESSION['ukey'] . "') ORDER BY ticket DESC LIMIT 10");
...
?>
    <tr>
        ...
        <td>
            ...
            echo '<a href="#" data-toggle="modal" data-target="#approve-mt-user-frm" data-whatever="' . @$show_total->ticket . '" class="btn btn-sm btn-warning btn-outline" data-top="toptitle" data-placement="top" title="ดำเนินการ"><i class="fa fa-check-circle"></i></a>';
            ?>
        </td>
