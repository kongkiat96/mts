...
<div class="modal-footer">
    ...
    <button class="ladda-button btn btn-primary btn-square btn-ladda bg-info" type="submit" name="save_approve_user_success" data-style="expand-left">
...
<input type="text"  name="set_status" id="set_status" value="<?php echo $chk_case->card_status;?>">
